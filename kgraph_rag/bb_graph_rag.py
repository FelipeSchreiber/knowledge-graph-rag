...
## check if the graph database was already loaded, i.e., if the file "query.txt" exists
if not os.path.isfile(fname):
    with open(fname,"w") as f:
        f.write("ok")
    # # read the wikipedia page for the Banco do Brasil
...
res = entity_chain.invoke(
    {"question": "In the year of 2023 who is the CEO of Banco do Brasil?"}
).names
# print(res)
...
res_simple = chain.invoke(
    {
        "question": "When was Banco do Brasil founded?",
    }
)
